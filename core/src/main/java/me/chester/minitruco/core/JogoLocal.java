...
public class JogoLocal extends Jogo {
     ...
     * @param baralhoLimpo true para baralho sem os 4, 5, 6, 7, false para baralho
     *                     completo (sujo)
     */
     ...
     *
     * @param jogadorQueAbre Jogador que abre a rodada
     */
     ...
     *
     * @param i 1 ou 2 para a respectiva equipe, 0 para ninguém aguardando mão
     *          de 11 (jogo normal)
     */
