...
public abstract class Jogo implements Runnable {
     ...
     *
     * @param c Carta cujo valor desejamos
     */
     ...
     *
     * @param j      Jogador que está respondendo
     * @param aceita true se o jogador topa jogar, false se deixar para o parceiro
     *               decidir
     */
     ...
     *
     * @param j Jogador que está solicitando o aumento
     */
     ...
     *
     * @param j       Jogador que respondeu ao pedido
     * @param aceitou <code>true</code> se ele mandou descer, <code>false</code> se
     *                correu
     */
     ...
     * jogador)
     *
     * @param s objeto a atualizar
     * @param j Jogador que receberá a situação
     */
     ...
     * eventos do jogo.
     *
     * @param jogador Jogador que será adicionado (CPU, humano, etc)
     ...
     *
     * @param c Carta virada. Ignorado se for jogo com manilha velha
     */
     ...
     * <p>
     *
     * @param posicao posição (1 a 4) do jogador que motivou o abort
     */
