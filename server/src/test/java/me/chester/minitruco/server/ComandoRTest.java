...
class ComandoRTest {
    ...
    void testTrocaParceirosDoGerente() {
        ...
        verify(j1).println("I j1|j3|bot|j2 P 1");
        verify(j2).println("I j1|j3|bot|j2 P 4");
        verify(j3).println("I j1|j3|bot|j2 P 2");
    }

    @Test
    void testInverteAdversariosDoGerente() {
        Comando.interpreta("R I", j1);
        verify(j1).println("I j1|bot|j3|j2 P 1");
        verify(j2).println("I j1|bot|j3|j2 P 4");
        verify(j3).println("I j1|bot|j3|j2 P 3");
    }
